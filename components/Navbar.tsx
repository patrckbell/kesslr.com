      ...
      <div className="max-w-8xl mx-auto px-4 sm:px-12 md:px-24 h-20 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4 sm:gap-8">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <img src="/images/logo.png" alt="Kesslr Labs" className="w-6 h-6 sm:w-8 sm:h-8 object-contain" />
            <span className="font-regular tracking-[0.2em] text-xs sm:text-sm text-white font-nippo">KESSLR LABS</span>
          </div>
