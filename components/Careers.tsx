...
const Careers: React.FC<CareersProps> = ({ scrollY }) => {
  ...
  const jobs = {
    'fpga-engineer': {
      ...
      about: `Kesslr Labs builds foundational compute infrastructure for systems where correctness is not optional. We work on electronic systems that operate beyond the reach of intervention, where failure is catastrophic, behaviour must be understood in advance, and confidence must be earned, not assumed.
